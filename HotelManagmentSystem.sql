...
DD'), TO_DATE('2025-10-04', 'YYYY-MM-DD')); 
 ...
 -- Insert into Customers 
    INSERT INTO Customers (FirstName, LastName, City, SubCity, Kebele, Email, Phone, Address, 
LoyaltyPoints) 
    VALUES ('Tewodros', 'Kassahun', 'Addis Ababa', 'Bole', 12, 'tewodros@gmail.com', 
'+251911112233', 'Bole Road', 100); 
    INSERT INTO Customers (FirstName, LastName, City, SubCity, Kebele, Email, Phone, Address, 
LoyaltyPoints)  
    VALUES ('Alemnesh', 'Girma', 'Addis Ababa', 'Kirkos', 5, 'alemnesh@gmail.com', 
'+251922334455', 'Kirkos St', 50); 
    INSERT INTO Customers (FirstName, LastName, City, SubCity, Kebele, Email, Phone, Address, 
LoyaltyPoints)  
    VALUES ('Yared', 'Getachew', 'Addis Ababa', 'Yeka', 4, 'yared@gmail.com', '+251933445566', 
'Yeka Ave', 75); 
 
 -- Insert into Employees 
    INSERT INTO Employees (FirstName, LastName, City, SubCity, Kebele, Salary, Position, Email, 
Phone, HireDate) 
    VALUES ('Abebe', 'Kebede', 'Addis Ababa', 'Bole', 12, 15000.00, 'Manager', 'abebe@gmail.com', 
'+251911223344', TO_DATE('2023-01-01', 'YYYY-MM-DD')); 
    INSERT INTO Employees (FirstName, LastName, City, SubCity, Kebele, Salary, Position, Email, 
Phone, HireDate)  
    VALUES ('Metadel', 'Werku', 'Addis Ababa', 'Kirkos', 5, 12000.00, 'Cashier', 
'metadel@gmail.com', '+251922334455', TO_DATE('2023-02-01', 'YYYY-MM-DD')); 
    INSERT INTO Employees (FirstName, LastName, City, SubCity, Kebele, Salary, Position, Email, 
Phone, HireDate)  
    VALUES ('Shegaw', 'Birhanu', 'Addis Ababa', 'Yeka', 4, 8000.00, 'Clerk', 'shegaw@gmail.com', 
'+251933445566', TO_DATE('2023-03-01', 'YYYY-MM-DD')); 
 
 -- Insert into Store 
    INSERT INTO Store (Name, Address, Phone, ManagerID, OpenTime, CloseTime) 
    VALUES ('FreshMart', 'Addis Ababa, Bole', '+251973546201', 1, TO_TIMESTAMP('08:00:00', 
'HH24:MI:SS'), TO_TIMESTAMP('20:00:00', 'HH24:MI:SS')); 
    INSERT INTO Store (Name, Address, Phone, ManagerID, OpenTime, CloseTime)  
    VALUES ('SuperSave', 'Addis Ababa, Kolfe Keraniyo', '+251921539151', 2, 
TO_TIMESTAMP('09:00:00', 'HH24:MI:SS'), TO_TIMESTAMP('21:00:00', 'HH24:MI:SS')); 
    INSERT INTO Store (Name, Address, Phone, ManagerID, OpenTime, CloseTime) 
    VALUES ('DailyNeeds', 'Addis Ababa, Yeka', '+251985073484', 3, TO_TIMESTAMP('07:00:00', 
'HH24:MI:SS'), TO_TIMESTAMP('22:00:00', 'HH24:MI:SS')); 
 
 -- Insert into Sales 
    INSERT INTO Sales (CustomerID, EmployeeID, StoreID, SaleDate, TotalAmount) 
    VALUES (1, 1, 1, TO_TIMESTAMP('2023-01-12 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), 
8000.00); 
    INSERT INTO Sales (CustomerID, EmployeeID, StoreID, SaleDate, TotalAmount) 
    VALUES (2, 2, 1, TO_TIMESTAMP('2023-02-18 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), 
1250.00); 
    INSERT INTO Sales (CustomerID, EmployeeID, StoreID, SaleDate, TotalAmount)  
    VALUES (3, 3, 2, TO_TIMESTAMP('2023-03-22 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), 
450.00); 
...
SELECT EmployeeID, FirstName, LastName, City, SubCity, Kebele, Position, Email, Phone, 
HireDate 
FROM Employees; -- DQL: -- SELECT with specific columns: Supplier names and phone numbers 
SELECT SupplierName, Phone FROM Suppliers; -- SELECT with alias: Rename columns in output 
SELECT ProductName AS Item, UnitPrice AS Price FROM Products; -- SELECT with WHERE: Employees with salary greater than 10000 
SELECT FirstName, LastName, Salary  
FROM Employees  
WHERE Salary > 10000; -- SELECT with ORDER BY: Products sorted by expiry date 
...
JOIN Products p ON od.ProductID = p.ProductID; -- SELECT with multiple JOINs: Bill details with employee and customer names 
...
JOIN Customers c ON s.CustomerID = c.CustomerID; -- SELECT with JOIN: Store details with phone numbers 
SELECT s.Name, s.Address, s.Phone 
FROM Store s; -- SELECT with GROUP BY: Number of products per category 
SELECT c.CategoryName, COUNT(p.ProductID) AS NumProducts  
FROM Categories c  
LEFT JOIN Products p ON c.CategoryID = p.CategoryID  
GROUP BY c.CategoryName; -- SELECT with subquery: Employees who have processed sales 
SELECT FirstName, LastName 
FROM Employees 
WHERE EmployeeID IN (SELECT DISTINCT EmployeeID FROM Sales); 
-- DML: Demonstration of Data Manipulation Statements -- SELECT with joins: Retrieve products ordered by a specific customer 
...
WHERE c.CustomerID = 1; -- INSERT: Add a new product 
INSERT INTO Products (ProductName, CategoryID, SupplierID, UnitPrice, Description, 
ManufactureDate, ExpiryDate) 
VALUES ('Tea', 2, 3, 40.00, 'GreenLeaf Tea', TO_DATE('2024-04-01', 'YYYY-MM-DD'), 
TO_DATE('2026-03-31', 'YYYY-MM-DD')); -- UPDATE: Modify a product's price 
UPDATE Products 
SET UnitPrice = 160.00 
WHERE ProductID = 1; -- Transaction with ROLLBACK 
BEGIN 
INSERT INTO Customers (FirstName, LastName, City, SubCity, Kebele, Email, Phone) 
VALUES ('New', 'Test', 'Addis Ababa', 'Bole', 12, 'new@example.com', '+251900000000'); -- Suppose something goes wrong, rollback the transaction 
ROLLBACK; 
END; 
...
GRANT SELECT ON Employees TO C##cashier_role; -- Create users and assign roles 
...
GRANT C##customer_role TO C##customer_user; -- DQL: Check Database Status 
